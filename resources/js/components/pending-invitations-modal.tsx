...
import TeamInvitationController from "#/actions/App/Http/Controllers/Teams/TeamInvitationController.ts";
...
export default function PendingInvitationsModal({ invitations, open, onOpenChange }: Props) {
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-sm">
                  {invitation.inviterName} invited you to join this team.
                </p>
              </div>
