...
return [
    ...
    |
    | Postgres backs sessions. "array" is what the test suite runs on.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Leave this unset so sessions resolve to the default database connection.
    | Set it only to move sessions onto a connection other than the default.
    |
    */
    ...
    */
    ...
    | Unused while the driver above is "database".
    |
    */
