...
- Run minimal tests with filter before finalizing: `pest --compact --filter=testName`.
- Run all tests: `pest --compact`.
- Run file: `pest --compact tests/Feature/ExampleTest.php`.
