...
- Run the minimum number of tests needed to ensure code quality and speed. Use `pest --compact` with a specific filename or filter.
...
- Run tests: `pest --compact` or filter: `pest --compact --filter=testName`.
